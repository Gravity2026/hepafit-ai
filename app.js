...
const foodDatabase = {
    es: {
        basic: [
            { id: "avena", cat: "breakfast", name: "Avena Integral", icon: "🌾", benefit: "Fibra soluble (Beta-glucanos)", desc: "Excelente para absorber grasas en el intestino antes de llegar al hígado.", difficulty: "Fácil", time: "10 min", kcal: 280, protein: 10, carbs: 48, fat: 5, points: 4, ingredients: ["1/2 taza de avena integral", "1 taza de agua o leche descremada", "Canela en polvo", "Media manzana verde picada"], steps: ["Calienta el agua en una olla pequeña.", "Añade la avena y baja el fuego a mínimo.", "Cocina por 5 minutos revolviendo suavemente.", "Sirve y añade canela y manzana verde."] },
            { id: "ajo", cat: "lunch", name: "Ajo y Cebolla", icon: "🧄", benefit: "Compuestos de Azufre", desc: "Activan las enzimas hepáticas que se encargan de limpiar las toxinas del cuerpo.", difficulty: "Muy Fácil", time: "5 min", kcal: 45, protein: 2, carbs: 8, fat: 0, points: 3, ingredients: ["1 diente de ajo crudo", "1 cucharadita de aceite de oliva"], steps: ["Pica finamente el ajo crudo.", "Déjalo reposar por 10 minutos para activar la alicina.", "Consúmelo directamente con el aceite de oliva."] },
            { id: "te_verde", cat: "beverage", name: "Té Verde", icon: "🍵", benefit: "Antioxidantes (Catequinas)", desc: "Disminuye la acumulación de grasas y desinflama los hepatocitos.", difficulty: "Fácil", time: "5 min", kcal: 2, protein: 0, carbs: 0, fat: 0, points: 3, ingredients: ["1 bolsita de té verde", "1 taza de agua a 80°C", "Gotas de limón"], steps: ["Calienta agua hasta antes de hervir.", "Vierte en la taza con la bolsa de té verde.", "Tapa y deja reposar 3 minutos.", "Retira la bolsa y agrega el limón."] },
            { id: "brocoli", cat: "lunch", name: "Brócoli al Vapor", icon: "🥦", benefit: "Glucosinolatos (Fase II)", desc: "Ayuda a activar los procesos de desintoxicación hepática en el hígado de forma natural.", difficulty: "Fácil", time: "8 min", kcal: 55, protein: 4, carbs: 11, fat: 0, points: 5, ingredients: ["1 taza de floretes de brócoli", "Agua", "Una pizca de sal", "Gotas de limón"], steps: ["Coloca el brócoli en una vaporera.", "Cocina al vapor por 5 minutos hasta que esté verde brillante.", "Sirve con una pizca de sal y unas gotas de limón."] },
            { id: "manzana_verde", cat: "snack", name: "Manzana Verde", icon: "🍏", benefit: "Ácido Málico y Pectina", desc: "La pectina ayuda a limpiar el tracto digestivo, aliviando de forma óptima la carga de trabajo del hígado.", difficulty: "Muy Fácil", time: "2 min", kcal: 80, protein: 0, carbs: 22, fat: 0, points: 4, ingredients: ["1 manzana verde fresca"], steps: ["Lava muy bien la manzana verde.", "Córtala en rodajas delgadas y consúmela con su piel para obtener mayor fibra."] },
            { id: "lentejas", cat: "lunch", name: "Lentejas al Curry", icon: "🍲", benefit: "Proteína Vegetal y Cúrcuma", desc: "Las lentejas aportan aminoácidos limpios y el curry contiene cúrcuma que actúa como un potente antiinflamatorio hepático.", difficulty: "Fácil", time: "25 min", kcal: 320, protein: 18, carbs: 54, fat: 2, points: 5, ingredients: ["1/2 taza de lentejas cocidas", "1 cdta de curry en polvo", "1 rodaja de jengibre", "Zanahoria picada"], steps: ["En una olla pequeña cocina la zanahoria picada junto con las lentejas.", "Añade el curry en polvo y el jengibre rallado.", "Cocina a fuego lento por 10 minutos para impregnar sabores."] }
        ],
        premium: [
            { id: "cardo", cat: "beverage", name: "Cardo Mariano", icon: "💊", benefit: "Silimarina Activa", desc: "El protector celular hepático más potente que ayuda a regenerar el tejido dañado de manera clínica.", difficulty: "Fácil", time: "10 min", kcal: 5, protein: 0, carbs: 1, fat: 0, points: 5, ingredients: ["1 cucharadita de semillas de cardo mariano", "1 taza de agua", "1 rodaja de jengibre"], steps: ["Machaca ligeramente las semillas.", "Hierve el agua con la rodaja de jengibre.", "Añade las semillas, apaga el fuego y tapa.", "Deja reposar por 10 minutos y cuela."] },
            { id: "salmon", cat: "lunch", name: "Salmón con Eneldo", icon: "🐟", benefit: "Omega 3 (EPA y DHA)", desc: "Desinflama las células hepáticas y evita la acumulación de triglicéridos dentro de los hepatocitos.", difficulty: "Media", time: "15 min", kcal: 340, protein: 32, carbs: 0, fat: 18, points: 5, ingredients: ["1 filete de salmón (150g)", "1 cdta de aceite de oliva virgen extra", "Eneldo, sal y limón"], steps: ["Sazona el salmón con sal, pimienta y eneldo.", "Calienta una sartén con el aceite de oliva.", "Cocina 4 minutos del lado de la piel, voltea y cocina 3 minutos más.", "Sirve con rodajas de limón."] },
            { id: "huevos", cat: "breakfast", name: "Huevos de Pastoreo", icon: "🍳", benefit: "Colina y Aminoácidos", desc: "La colina es un nutriente esencial para que el hígado pueda exportar las grasas y evitar la esteatosis visceral.", difficulty: "Fácil", time: "6 min", kcal: 160, protein: 14, carbs: 1, fat: 11, points: 4, ingredients: ["2 huevos de pastoreo", "1 cdta de aceite de coco o ghee", "Una pizca de sal marina"], steps: ["Calienta el sartén con el aceite de coco a fuego medio.", "Cocina los huevos revueltos suavemente.", "Sazona con sal marina al gusto y sirve."] },
            { id: "aguacate", cat: "snack", name: "Aguacate / Palta", icon: "🥑", benefit: "Grasas Monoinsaturadas", desc: "Ayuda al cuerpo a producir glutatión de forma natural, el antioxidante maestro para la depuración del hígado.", difficulty: "Muy Fácil", time: "3 min", kcal: 240, protein: 3, carbs: 12, fat: 22, points: 4, ingredients: ["1/2 aguacate maduro", "Unas gotas de limón", "Sal y pimienta"], steps: ["Corta el aguacate a la mitad.", "Extrae la pulpa con una cuchara, aplástala con un tenedor y añade limón, sal y pimienta."] },
            { id: "curcuma_latte", cat: "beverage", name: "Cúrcuma Latte", icon: "🥛", benefit: "Curcumina activa", desc: "Bebida dorada antiinflamatoria que ayuda activamente a la regeneración celular del hígado.", difficulty: "Fácil", time: "5 min", kcal: 90, protein: 4, carbs: 8, fat: 4, points: 4, ingredients: ["1 taza de leche de almendras sin azúcar", "1 cdta de cúrcuma en polvo", "Una pizca de pimienta negra", "1 cdta de miel de abejas pura"], steps: ["Calienta la leche de almendras sin dejar que hierva.", "Agrega la cúrcuma, la pimienta negra y mezcla muy bien.", "Sirve en una taza y endulza con la miel de abejas."] },
            { id: "ensalada_quinoa", cat: "lunch", name: "Ensalada de Quinoa y Espinaca", icon: "🥗", benefit: "Aminoácidos y Clorofila", desc: "La quinoa y la espinaca asisten en limpiar metales pesados y proporcionan proteínas de origen vegetal de alta asimilación.", difficulty: "Fácil", time: "12 min", kcal: 260, protein: 9, carbs: 38, fat: 8, points: 5, ingredients: ["1/2 taza de quinoa cocida", "1 taza de hojas de espinaca baby", "1 cucharada de aceite de oliva", "Semillas de calabaza"], steps: ["Lava y escurre la espinaca baby muy bien.", "Mezcla en un tazón con la quinoa cocida fría.", "Adereza con aceite de oliva y decora con semillas de calabaza tostadas."] }
        ]
    },
    en: {
        basic: [
            { id: "avena", cat: "breakfast", name: "Whole Oats", icon: "🌾", benefit: "Soluble Fiber (Beta-glucans)", desc: "Excellent for absorbing fats in the gut before they reach the liver.", difficulty: "Easy", time: "10 min", kcal: 280, protein: 10, carbs: 48, fat: 5, points: 4, ingredients: ["1/2 cup of whole oats", "1 cup of water or skim milk", "Cinnamon powder", "Half chopped green apple"], steps: ["Heat water in a small pot.", "Add oats and reduce heat to minimum.", "Cook for 5 minutes, stirring gently.", "Serve and top with cinnamon and green apple."] },
            { id: "ajo", cat: "lunch", name: "Garlic & Onion", icon: "🧄", benefit: "Sulfur Compounds", desc: "Activate liver enzymes responsible for clearing toxins from the body.", difficulty: "Very Easy", time: "5 min", kcal: 45, protein: 2, carbs: 8, fat: 0, points: 3, ingredients: ["1 raw garlic clove", "1 teaspoon of olive oil"], steps: ["Finely chop raw garlic.", "Let it rest for 10 minutes to activate allicin.", "Consume directly with olive oil."] },
            { id: "te_verde", cat: "beverage", name: "Green Tea", icon: "🍵", benefit: "Antioxidants (Catechins)", desc: "Decreases fat accumulation and reduces inflammation in hepatocytes.", difficulty: "Easy", time: "5 min", kcal: 2, protein: 0, carbs: 0, fat: 0, points: 3, ingredients: ["1 green tea bag", "1 cup of hot water at 80°C", "Lemon drops"], steps: ["Heat water until just before boiling.", "Pour into a cup with the green tea bag.", "Cover and steep for 3 minutes.", "Remove bag and add lemon drops."] },
            { id: "brocoli", cat: "lunch", name: "Steamed Broccoli", icon: "🥦", benefit: "Glucosinolates (Phase II)", desc: "Helps activate natural liver detoxification pathways.", difficulty: "Easy", time: "8 min", kcal: 55, protein: 4, carbs: 11, fat: 0, points: 5, ingredients: ["1 cup of broccoli florets", "Water", "Pinch of salt", "Lemon drops"], steps: ["Place broccoli in a steamer basket.", "Steam for 5 minutes until bright green.", "Serve with salt and fresh lemon juice."] },
            { id: "manzana_verde", cat: "snack", name: "Green Apple", icon: "🍏", benefit: "Malic Acid & Pectin", desc: "Pectin cleanses the digestive tract, relieving the liver's workload.", difficulty: "Very Easy", time: "2 min", kcal: 80, protein: 0, carbs: 22, fat: 0, points: 4, ingredients: ["1 fresh green apple"], steps: ["Wash the green apple thoroughly.", "Slice it and consume with the skin on for maximum fiber."] },
            { id: "lentejas", cat: "lunch", name: "Curry Lentils", icon: "🍲", benefit: "Plant Protein & Turmeric", desc: "Lentils provide clean amino acids and curry has anti-inflammatory turmeric.", difficulty: "Easy", time: "25 min", kcal: 320, protein: 18, carbs: 54, fat: 2, points: 5, ingredients: ["1/2 cup cooked lentils", "1 tsp curry powder", "1 slice ginger", "Chopped carrot"], steps: ["In a small pot, cook carrot and lentils.", "Add curry powder and grated ginger.", "Simmer for 10 minutes."] }
        ],
        premium: [
            { id: "cardo", cat: "beverage", name: "Milk Thistle", icon: "💊", benefit: "Active Silymarin", desc: "The most potent liver cell protector that helps regenerate damaged tissues.", difficulty: "Easy", time: "10 min", kcal: 5, protein: 0, carbs: 1, fat: 0, points: 5, ingredients: ["1 tsp of crushed milk thistle seeds", "1 cup of water", "1 slice of ginger"], steps: ["Crush seeds lightly to release active ingredients.", "Boil water with the ginger slice.", "Add seeds, turn off heat, and cover.", "Let steep for 10 minutes and strain."] },
            { id: "salmon", cat: "lunch", name: "Dill Seared Salmon", icon: "🐟", benefit: "Omega 3 (EPA & DHA)", desc: "Reduces liver inflammation and blocks triglyceride buildup.", difficulty: "Medium", time: "15 min", kcal: 340, protein: 32, carbs: 0, fat: 18, points: 5, ingredients: ["1 salmon fillet (150g)", "1 tsp extra virgin olive oil", "Dill, salt, and lemon"], steps: ["Season salmon with salt, pepper, and dill.", "Heat pan with olive oil over medium-high heat.", "Cook 4 minutes skin-side down, flip and cook 3 minutes more.", "Serve with fresh lemon slices."] },
            { id: "huevos", cat: "breakfast", name: "Pastured Eggs", icon: "🍳", benefit: "Choline & Amino Acids", desc: "Choline is essential for exporting fat from the liver to prevent fatty liver disease.", difficulty: "Easy", time: "6 min", kcal: 160, protein: 14, carbs: 1, fat: 11, points: 4, ingredients: ["2 pastured eggs", "1 tsp coconut oil or ghee", "Pinch of sea salt"], steps: ["Heat pan with coconut oil.", "Cook eggs scrambled over medium heat.", "Season with sea salt and serve."] },
            { id: "aguacate", cat: "snack", name: "Avocado", icon: "🥑", benefit: "Monounsaturated Fats", desc: "Helps the body produce glutathione, the liver's master antioxidant.", difficulty: "Very Easy", time: "3 min", kcal: 240, protein: 3, carbs: 12, fat: 22, points: 4, ingredients: ["1/2 ripe avocado", "A few drops of lemon juice", "Salt and pepper"], steps: ["Cut the avocado in half.", "Scoop out pulp, mash with a fork, and add lemon juice, salt, and pepper."] },
            { id: "curcuma_latte", cat: "beverage", name: "Golden Turmeric Latte", icon: "🥛", benefit: "Active Curcumin", desc: "Anti-inflammatory golden drink supporting liver cell regeneration.", difficulty: "Easy", time: "5 min", kcal: 90, protein: 4, carbs: 8, fat: 4, points: 4, ingredients: ["1 cup unsweetened almond milk", "1 tsp turmeric powder", "Pinch black pepper", "1 tsp raw honey"], steps: ["Warm almond milk without boiling.", "Stir in turmeric, black pepper, and mix well.", "Pour into cup and sweeten with honey."] },
            { id: "ensalada_quinoa", cat: "lunch", name: "Quinoa & Spinach Salad", icon: "🥗", benefit: "Amino Acids & Chlorophyll", desc: "Quinoa and spinach help clear heavy metals and provide highly digestible plant proteins.", difficulty: "Easy", time: "12 min", kcal: 260, protein: 9, carbs: 38, fat: 8, points: 5, ingredients: ["1/2 cup cooked quinoa", "1 cup baby spinach leaves", "1 tbsp olive oil", "Pumpkin seeds"], steps: ["Wash and drain baby spinach.", "Mix in a bowl with cooled quinoa.", "Dress with olive oil and top with pumpkin seeds."] }
        ]
    }
};
